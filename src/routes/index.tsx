...
function HomePage() {
  return (
    <SiteLayout>
      <section className="hero"><div className="wrap"> <div> <div className="eyebrow">Arlington· McLean· Serving the Northern Virginia· Telehealth in Virginia &amp; Utah</div> <h1>Feel grounded in yourself — and <em>connected</em> to the people you love.</h1> <p className="sub">Compassionate, down-to-earth therapy for adults and couples navigating anxiety, trauma, and relationships. I'll help you quiet the inner critic, trust your own voice, and create change that lasts.</p> <div className="cta-row"><Link className="btn lg" to="/book">Book a free 15-minute consultation</Link><Link className="btn ghost lg" to="/explore">Explore therapy</Link></div> <div className="trust"><span><b>20+ years</b> of experience</span><span><b>EMDR</b> &amp; IFS trained</span><span><b>Certified</b> Group Psychotherapist</span></div> </div><div className="portrait" style={{"aspectRatio": "4/5"}}><img className="pfoto" src="/brand/emily_full.jpg" alt="Emily M. Jones, LCSW" /><div className="tag"><b>Emily M. Jones</b>LCSW, CGP· in-person &amp; virtual</div></div>
      </div></section> <section className="band cream"><div className="wrap"> <div className="center"><div className="kick">You don't have to keep doing this alone</div><h2>Does any of this sound familiar?</h2></div> <div className="paingrid"> <div className="pain"><span className="dot">✓</span><span>You look fine on the outside, but inside you feel anxious, stuck, or never quite good enough.</span></div><div className="pain"><span className="dot">✓</span><span>Your relationships feel harder than they should — you withdraw, react, or over-give.</span></div><div className="pain"><span className="dot">✓</span><span>Old pain from the past keeps showing up in the present.</span></div><div className="pain"><span className="dot">✓</span><span>You're successful by every measure, yet something still feels missing.</span></div><div className="pain"><span className="dot">✓</span><span>You're ready to understand yourself, not just cope.</span></div><div className="pain"><span className="dot">✓</span><span>You want a therapist who's warm <em>and</em> honest with you.</span></div> </div> <p className="reassure">"When we trust our sense of what's right for us, we find our passions, our people, and the life we want."</p>
      </div></section> <section className="band"><div className="wrap"> <div className="center"><div className="kick">Ways we can work together</div><h2>Therapy tailored to where you are</h2> <p className="sub2">In person in Arlington &amp; McLean, VA — serving the greater Northern Virginia — and by secure video across Virginia &amp; Utah.</p></div> <div className="cards"> <div className="cardx"><div className="ic"><svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 12a5 5 0 100-10 5 5 0 000 10zm0 2c-5 0-9 2.5-9 6v2h18v-2c0-3.5-4-6-9-6z" /></svg></div><h3>Individual Therapy</h3><p>Depth-oriented work for anxiety, trauma, self-worth, and life transitions — using EMDR, IFS, and attachment-focused approaches.</p><div className="price">From $250 / 50 min</div><Link className="more" to="/individual">Learn more →</Link></div> <div className="cardx"><div className="ic"><svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 12a5 5 0 100-10 5 5 0 000 10zm0 2c-5 0-9 2.5-9 6v2h18v-2c0-3.5-4-6-9-6z" /></svg></div><h3>Couples Therapy</h3><p>Emotion-focused work for partners who love each other but keep getting stuck in the same painful patterns.</p><div className="price">$300 / session</div><Link className="more" to="/couples">Learn more →</Link></div> <div className="cardx"><div className="ic"><svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 12a5 5 0 100-10 5 5 0 000 10zm0 2c-5 0-9 2.5-9 6v2h18v-2c0-3.5-4-6-9-6z" /></svg></div><h3>Group Therapy</h3><p>Weekly, confidential groups — including one for professional women — to practice showing up as the partner, parent, and professional you want to be.</p><div className="price">$125 / session</div><Link className="more" to="/group">Learn more →</Link></div> </div>
      </div></section> <section className="band cream"><div className="wrap"> <div className="center"><div className="kick">Simple, low-pressure, no commitment</div><h2>Getting started is easy</h2> <p className="sub2">Reaching out is often the hardest part. Here's exactly what happens next.</p></div> <div className="steps"> <div className="step"><div className="num">1</div><h4>Book a free consult</h4><p>Pick a time for a free 15-minute call. We'll talk about what's bringing you in and whether we're a good fit.</p></div> <div className="step"><div className="num">2</div><h4>Your first session</h4><p>We'll go at your pace — getting to know your story, your goals, and what you want to feel differently.</p></div> <div className="step"><div className="num">3</div><h4>Real, lasting change</h4><p>Weekly sessions in Arlington, McLean, or by video. Over time you'll trust yourself more and live more freely.</p></div> </div> <div style={{"textAlign": "center", "marginTop": "32px"}}><Link className="btn lg" to="/book">Book your free consultation</Link></div>
      </div></section> <section className="band optin"><div className="wrap"><div className="box"> <div className="art"> <div className="kick" style={{"fontSize": "12.5px", "letterSpacing": ".15em", "textTransform": "uppercase", "fontWeight": "700", "marginBottom": "10px"}}>Free guide</div> <h3>Composed at work, unraveling underneath?</h3> <p style={{"color": "#ecdfd4", "margin": "0 0 8px"}}>Get <em>Quiet the Inner Critic</em> — 5 first steps for high-achieving women who look calm on the outside but feel anxious and never quite “enough” inside.</p> <ul><li>Why high-functioning anxiety hides in plain sight</li><li>A 2-minute practice to soften the inner critic</li><li>How to tell when it's time to reach out</li></ul> </div> <div className="form"> {'{'{'}'}OPTIN{'}'}</div>
      </div></div></section> <section className="band finalcta"> <div className="wrap"><h2>You can live true to yourself — and love more.</h2><p>Take the first small step today. Book a free, no-pressure 15-minute consultation and let's see if we're a good fit.</p> <Link className="btn lg" to="/book">Book a free 15-minute consultation</Link> <p style={{"marginTop": "22px", "fontSize": "15px", "color": "#d8c2af"}}>Prefer to talk first? Call <b style={{"color": "#f4e0cc"}}>(571) 582-8086</b> — I'll get back to you within one business day.</p></div></section>
