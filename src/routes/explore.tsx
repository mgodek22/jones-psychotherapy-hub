...
function ExplorePage() {
  return (
    <FunnelLayout>
      ...
      <section className="band cream" id="start"><div className="wrap"> <div className="center"><div className="kick">Two easy ways to start</div><h2>Tell me a little, or just call.</h2> <p className="sub2" style={{"maxWidth": "600px", "margin": "6px auto 0"}}>Share a few details and I'll personally reach out within one business day. Prefer to talk now? Call <a href={PHONE_HREF} style={{"color": "var(--coral-d)", "fontWeight": "600"}}>(571) 582-8086</a>.</p></div> {'{'{'}'}CONSULT ctaLabel="Send my information"{'}'}
      </div></section>
    </FunnelLayout>
  );
}
