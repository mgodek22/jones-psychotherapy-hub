...
function CouplesPage() {
  return (
    <SiteLayout crumbs={[
      ...
      <section className="hero solo"><div className="wrap"><div> <div className="eyebrow">Couples Therapy· McLean & Arlington, VA· Telehealth</div><h1>Love each other — but keep getting <em>stuck</em>?</h1><p className="sub">Emotion-focused couples therapy to help you break the cycle, rebuild trust, and feel close again.</p> <div className="cta-row"><Link to="/book" className="btn lg">Book a free 15-minute consultation</Link></div></div></div></section>
