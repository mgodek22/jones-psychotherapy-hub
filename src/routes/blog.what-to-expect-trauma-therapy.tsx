...
function BlogWhatToExpectTraumaTherapyPage() {
  return (
    <SiteLayout crumbs={[
      ...
      <div className="pullquote"><p>&ldquo;Being able to feel safe with other people is probably the single most important aspect of mental health.&rdquo;</p><cite>&mdash; Bessel van der Kolk, M.D., The Body Keeps the Score</cite></div>
