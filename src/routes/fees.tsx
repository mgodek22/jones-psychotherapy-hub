...
function FeesPage() {
  return (
    <SiteLayout crumbs={[
      ...
      <section className="hero solo"><div className="wrap"><div> <div className="eyebrow">Fees & Insurance· Clear and upfront</div><h1>Transparency, before you ever reach out.</h1><p className="sub">Here's exactly what to expect, so you can decide with all the information in front of you.</p> <div className="cta-row"><Link to="/book" className="btn lg">Book a free 15-minute consultation</Link></div></div></div></section>
