...
function BlogHowCouplesTherapyWorksPage() {
  return (
    <SiteLayout crumbs={[
      ...
      <div className="pullquote"><p>&ldquo;Love is not the icing on the cake of life. It is a basic primary need, like oxygen or water.&rdquo;</p><cite>&mdash; Dr. Sue Johnson, Hold Me Tight</cite></div>
