...
function BlogWhatIsGroupTherapyPage() {
  return (
    <SiteLayout crumbs={[
      ...
      <div className="pullquote"><p>&ldquo;It's the relationship that heals, the relationship that heals, the relationship that heals.&rdquo;</p><cite>&mdash; Irvin D. Yalom, M.D., group psychotherapy pioneer</cite></div>
      <h3>Who it helps</h3>
