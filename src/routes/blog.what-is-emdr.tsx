...
function BlogWhatIsEmdrPage() {
  return (
    <SiteLayout crumbs={[
      ...
      <div className="pullquote"><p>“Once the block is removed, healing resumes. EMDR therapy demonstrates that a similar sequence of events occurs with mental processes.”</p><cite>— The EMDR Institute, founded by Francine Shapiro, Ph.D.</cite></div>
