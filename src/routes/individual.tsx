...
function IndividualPage() {
  return (
    <SiteLayout crumbs={[
      ...
      <section className="hero solo"><div className="wrap"><div> <div className="eyebrow">Individual Therapy· Arlington &amp; McLean, VA· Telehealth</div><h1>Do you want to feel <em>empowered</em> to change your life?</h1><p className="sub">You are not alone. Together we'll turn painful emotions into a sense of freedom and lightness — and help you feel more connected to yourself and others.</p> <div className="cta-row"><Link className="btn lg" to="/book">Book a free 15-minute consultation</Link></div></div></div></section>
